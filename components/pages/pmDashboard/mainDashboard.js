...
import { AiOutlineHome, AiOutlineMail, AiOutlineMessage, AiOutlineUser, AiOutlineSetting, AiOutlineCheckSquare } from "react-icons/ai";
...
// import TenderList2 from './tender/tenderList2'
        ...
        <>
            ...
            <div className='mother'>
                <div className='item-1 item'><br />
                    ...
                    <span style={{marginLeft: -110}}><AiOutlineCheckSquare size={20} className='lolon'/>Tender</span> 
                    <div className="dropdowns-content">
                     <a onClick={toTender} >TenderList</a>
                     <a onClick={toTendering}>AddTender</a>
                     {/* <a onClick={toTender1}>Tender Pages</a> */}
                     <a onClick={toTender3}>Tender Page</a>
                     </div>
                </button>
                ...
                {step === 1 ? <Dashboard /> : step === 2 ? <Messages/> : step === 3 ? <Chats/> : step === 4 ? <TenderList/> : step === 8 ? <TenderPages/>  : step === 10 ? <Profile/> :step === 11 ? <AddTender/>  : <Settings/>}
                </div>
            </div>
        </>
    )
