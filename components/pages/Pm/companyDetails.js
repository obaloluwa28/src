          ...
          <>
            ...
            {phase === 1 ?
             ...
             <span style={{ marginLeft: '16%', position: 'absolute', fontSize: 17 }}>Hi, {name}
                ...
                <input id="formStyle" value={userr.companyName} type="text" placeholder="Company Name" /><br /><br />
                ...
                <input id="formStylee" type="text" value={userr.phone} readOnly={true} placeholder="Company Telephone" /><br /><br />
              ...
              <>
                ...
                }} id="formStyle" type="text" placeholder="Telephone" /><br /><br />
                <label id="formLabel">Email</label><br />
                <input value={contactEmail} onChange={(e) => {
                  setContactEmail(e.target.value)
                }} id="formStyle" type="text" placeholder="Email" /><br /><br />
