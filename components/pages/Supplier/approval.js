...
import approval from '../../images/8-WaitForApproval.png'
...
const Approval = () => {
  ...
  const getSupplier = (id) => {
    ...
    axios.get(`${API}user/supplier/${id}/`)
      .then(response => {
        // console.log(response.data[0].document)
  ...
  return (
    ...
    <>
      ...
      <div id="container">
        ...
        <center ><img src = {approval} width = {400} height = {600} style = {{marginTop : "80px"}}/></center>
