...
import companyDetails from '../../images/4-CompanyDetails.png'
    ...
    <>
      ...
      <div id="container">
        ...
        <aside id="sideBar">
          ...
          <center ><img src={companyDetails} width={400} height={600} style={{ marginTop: "80px" }} /></center>
        ...
        <section id="RegisterBar">
          ...
          {phase === 1 ?
            <>
              ...
              <label id="formLabel">Insurance Categories</label><br />
              <Multiselect id="formStyleSelected" />
              <br />
              <label id="formLabel">Policy ID</label><br />
              <input id="formStylee" type="number" placeholder="Policy number" /><br /><br />
              ...
              <input id="formStyle" readOnly={true} value={userr.email} type="email" placeholder="Company Email" /><br /><br />
              <label id="formLabel">Company Website</label><br />
              <input onChange={(e) => {
                setContactWebsite(e.target.value)
              }} id="formStyle" type="url" placeholder="Company Website" /><br />
