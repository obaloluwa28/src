...
import Summary from './profile/profileSummary'
        ...
        <>
            ...
            <div className='mother'>
                <div className='item-1 item'><br />
                    ...
                    <button className='bbb' onClick={toprofileSum}><span style={{ marginLeft: -112 }}><AiOutlineUser size={20} className='lolon' /> Profile </span> </button>
                ...
                <div className='item-2 item'>
                    {step === 1 ? <Dashboard /> : step === 2 ? <Messages /> : step === 3 ? <Chats /> : step === 4 ? <Summary /> : <Settings />}
                </div>
            </div>
        </>
    )
